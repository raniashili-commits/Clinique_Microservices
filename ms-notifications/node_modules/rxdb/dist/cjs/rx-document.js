...
var basePrototype = exports.basePrototype = {
  ...
  get deleted$() {
    ...
    return _this.$.pipe((0, _operators.map)(d => d._data._deleted), (0, _operators.distinctUntilChanged)());
  },
  get deleted$$() {
    var _this = this;
  ...
  get $() {
    ...
    return (0, _rxjs.defer)(() => {
      var latestDocData = _this.collection._docCache.getLatestDocumentData(id);
      return _this.collection.eventBulks$.pipe((0, _operators.filter)(bulk => !bulk.isLocal), (0, _operators.map)(bulk => bulk.events.find(ev => ev.documentId === id)), (0, _operators.filter)(event => !!event), (0, _operators.map)(changeEvent => (0, _rxChangeEvent.getDocumentDataOfRxChangeEvent)((0, _index.ensureNotFalsy)(changeEvent))), (0, _operators.startWith)(latestDocData), (0, _operators.distinctUntilChanged)((prev, curr) => prev._rev === curr._rev), (0, _operators.map)(docData => this.collection._docCache.getCachedRxDocument(docData)));
    }).pipe((0, _operators.shareReplay)(_index.RXJS_SHARE_REPLAY_DEFAULTS));
  },
  get $$() {
    var _this = this;
    var reactivity = _this.collection.database.getReactivityFactory();
  ...
  get$(path) {
    ...
    return this.$.pipe((0, _operators.map)(data => (0, _index.getProperty)(data, path)), (0, _operators.distinctUntilChanged)((prev, curr) => {
      /**
       ...
       */
      return (0, _index.deepEqual)(prev, curr);
    }));
  },
  get$$(path) {
  ...
  populate(path) {
    ...
    var ref = schemaObj.ref ? schemaObj.ref : schemaObj.type === 'array' && schemaObj.items && schemaObj.items.ref ? schemaObj.items.ref : undefined;
    if (!ref) {
    ...
    var refCollection = this.collection.database.collections[ref];
    if (!refCollection) {
  ...
  _context) {
    ...
    var newData = await (0, _incrementalWrite.modifierFromPublicToInternal)(mutationFunction)((0, _index.clone)(oldData));
