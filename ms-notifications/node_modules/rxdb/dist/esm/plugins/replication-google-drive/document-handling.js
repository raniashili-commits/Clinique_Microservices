...
export async function updateDocumentFiles(googleDriveOptions, primaryPath, docs, fileMetaByDocId, concurrency = 5) {
  ...
  async function worker() {
    while (queue.length) {
      ...
      var meta = ensureNotFalsy(fileMetaByDocId[docId]);
