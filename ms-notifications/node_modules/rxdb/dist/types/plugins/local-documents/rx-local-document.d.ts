...
export declare function getRxDatabaseFromLocalDocument(doc: RxLocalDocument<any> | RxLocalDocumentClass): RxDatabase<import("../../index.ts").CollectionsOfDatabase, any, {}, unknown> | import("../../rx-database.ts").RxDatabaseBase<any, any, any, any>;
