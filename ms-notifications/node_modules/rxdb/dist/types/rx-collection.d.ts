...
export declare class RxCollectionBase<InstanceCreationOptions, RxDocumentType = {
    ...
    liveQueryUpdateThrottleTime: number | undefined;
    /**
    ...
    */
    ...
    insert(json: RxDocumentType | RxDocument): Promise<RxDocument<RxDocumentType, OrmMethods, Reactivity>>;
    insertIfNotExists(json: RxDocumentType | RxDocument): Promise<RxDocument<RxDocumentType, OrmMethods, Reactivity>>;
     ...
     */
    upsert(json: Partial<RxDocumentType>, options?: UpsertOptions): Promise<RxDocument<RxDocumentType, OrmMethods, Reactivity>>;
    /**
    ...
    find(queryObj?: MangoQuery<RxDocumentType>): RxQuery<RxDocumentType, RxDocument<RxDocumentType, OrmMethods, Reactivity>[], OrmMethods, Reactivity>;
    findOne(queryObj?: MangoQueryNoLimit<RxDocumentType> | string): RxQuery<RxDocumentType, RxDocument<RxDocumentType, OrmMethods, Reactivity> | null, OrmMethods, Reactivity>;
     ...
     */
    findByIds(ids: string[]): RxQuery<RxDocumentType, Map<string, RxDocument<RxDocumentType, OrmMethods, Reactivity>>, OrmMethods, Reactivity>;
    /**
 ...
 */
export declare function createRxCollection({ database, name, schema, instanceCreationOptions, migrationStrategies, autoMigrate, statics, methods, attachments, options, localDocuments, cacheReplacementPolicy, conflictHandler, storageInstance, liveQueryUpdateThrottleTime }: any): Promise<RxCollection>;
