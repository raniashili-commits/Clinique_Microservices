...
export declare class RxDatabaseBase<Internals, InstanceCreationOptions, Collections = CollectionsOfDatabase, Reactivity = unknown> {
    ...
    readonly liveQueryUpdateThrottleTime: number;
    readonly idleQueue: IdleQueue;
    readonly rxdbVersion = "17.2.0";
    /**
     ...
     * Stores information documents about the collections of the database
     */
    internalStore: RxStorageInstance<InternalStoreDocType, Internals, InstanceCreationOptions>, hashFunction: HashFunction, cleanupPolicy?: Partial<RxCleanupPolicy> | undefined, allowSlowCount?: boolean | undefined, reactivity?: RxReactivityFactory<any> | undefined, onClosed?: (() => void) | undefined, liveQueryUpdateThrottleTime?: number);
...
}, Internals = any, InstanceCreationOptions = any, Reactivity = unknown>({ storage, instanceCreationOptions, name, password, multiInstance, eventReduce, ignoreDuplicate, options, cleanupPolicy, closeDuplicates, allowSlowCount, localDocuments, hashFunction, reactivity, liveQueryUpdateThrottleTime }: RxDatabaseCreator<Internals, InstanceCreationOptions, Reactivity>): Promise<RxDatabase<Collections, Internals, InstanceCreationOptions, Reactivity>>;
/**
